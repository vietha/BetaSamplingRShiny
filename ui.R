...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      numericInput("sl_value", label = "Specification Limit (SL)", value = 10e-06, min = 0, step = 0.01),
      ...
      #   #radioButtons("sdtype", "Theta", choices = c("Known", "Unknown"), inline = TRUE, selected = "Known"),
        numericInput("theta_value", "Precision Parameter (𝜃)", value = 4.4e+07, min = 0, step = 0.01),
      #),
